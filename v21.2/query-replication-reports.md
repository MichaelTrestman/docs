...
Only members of the `admin` role can access these tables. By default, the `root` user belongs to the `admin` role. For more information about users and roles, see [Manage Users](security-reference/authorization.html#create-and-manage-users) and [Manage Roles](security-reference/authorization.html#create-and-manage-roles).
